...
此示例演示了 Entities 上不同 URP Lit 材质属性的材质属性覆盖。

<img src="../../../../READMEimages/URPLitProperties.PNG" width="600">

## 它显示了什么？

scene 包含使用 URP Lit 着色器的球体。球体位于子场景中。
...
4. 在 Inspector 中，注意有几个 URP 材质属性 Authoring components。如果要覆盖其他 URP 材质属性，可以添加其他 URP 材质属性 Authoring components
