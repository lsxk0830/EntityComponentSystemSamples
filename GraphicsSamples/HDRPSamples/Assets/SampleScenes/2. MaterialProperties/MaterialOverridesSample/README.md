...
scene 包含使用 HDRP Lit 和 HDRP Unlit 着色器和 Shader Graph 的球体。附加在 MeshRenderer 上的球体 MaterialOverride component 会覆盖材质属性值。MaterialOverride component 引用 MaterialOverride 资产，您可以使用该资产来配置要覆盖的属性。
