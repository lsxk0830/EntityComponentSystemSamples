# Entities Graphics HDRP 示例项目
该项目包括 HDRP Entities Graphics 的功能示例 Scenes。
...
| HDRPLitProperties | 演示 Entities 上不同 HDRP Lit 材质属性的材质属性覆盖 | ![](READMEimages/HDRPLitProperties.PNG) |
| HDRPShaders | 演示 Entities 上的 HDRP Lit、LitTessellation、Unlit、LayeredLit、LayeredLitTessellation 着色器的材质属性覆盖 | ![](READMEimages/HDRPShaders.PNG) |
...
| TriggerParticles | 演示如何从 ECS System 演奏 VFX | ![](READMEimages/TriggerParticles.PNG) |
...
| MatrixPrevious | 演示移动 Entities 并支持 HDRP 运动矢量 | ![](READMEimages/MatrixPrevious.PNG) |
